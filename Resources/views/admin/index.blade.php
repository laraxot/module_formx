...
@section('content')
    {{-- 
    <x-formx::input type="password" name="test" label="label1" class="form-control" wire:model="aaa" />
    --}}
  ...
  {{-- 
    <x-theme::avatar type="circle" size="sm" img_src="{{ asset('') }}">AAAAAAAAAAAA</x-thene::avatar.circle>
